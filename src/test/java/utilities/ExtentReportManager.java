...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Display BookShelves"); // Title of report
		sparkReporter.config().setReportName("Display BookShelves in URBAN LADDER"); // name of the report
